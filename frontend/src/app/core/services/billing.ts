...
export class Billing {
  ...
  async billingGenerate(
    ...
    mode: 'preview' | 'direct'
      ...
      const res: any = await firstValueFrom(
        this.http.post<any>(`${this.apiUrl}/billing/${code}/generate`, fd, { withCredentials: true }))
      return res
  }
  ...
  async billingList(code: string) {
    const res: any = await firstValueFrom(this.http.get(`${this.apiUrl}/billing/${code}/list`, { withCredentials: true }))
    return res.list
  }
  ...
  async deleteBilling(_id: string, code: string) {
    const res: any = await firstValueFrom(this.http.delete(`${this.apiUrl}/billing/${code}/${_id}`, { withCredentials: true }))
    return res
  }
