...
export class PositionService {
  ...
  addPosition(data: any): Observable<any> {
    return this.http
      .post(`${this.baseUrl}/add-position`, data, this.httpOptions)
  ...
  getPositions(offset?: number | null, limit?: number | null): Observable<any> {
    if (offset == null && limit == null) {
      return this.http
        .get(`${this.baseUrl}/get-positions`, this.httpOptions)
        .pipe(catchError(this.handleError<any>(this.err)));
    } else {
      return this.http
        .get(
          `${this.baseUrl}/get-positions/${offset}/${limit}`,
          this.httpOptions
        )
        .pipe(catchError(this.handleError<any>(this.err)));
    }
  ...
  getPosition(id: number): Observable<any> {
    return this.http
      .get(`${this.baseUrl}/get-position/${id}`, this.httpOptions)
      .pipe(catchError(this.handleError<any>(this.err)));
  }

  editPosition(id: number, data: any): Observable<any> {
    return this.http
      .put(`${this.baseUrl}/edit-position/${id}`, data, this.httpOptions)
      .pipe(catchError(this.handleError<any>(this.err)));
  }

  delPosition(id: number): Observable<any> {
    return this.http
      .get(`${this.baseUrl}/delete-position/${id}`, this.httpOptions)
      .pipe(catchError(this.handleError<any>(this.err)));
  }
